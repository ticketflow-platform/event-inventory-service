...
import ru.ticketflowplatform.eventinventoryservice.domain.model.dto.in.CreateEventRequestDto;
...
public class EventController {
    ...
    @PostMapping
    CreateEventResponseDto create(@RequestBody @Valid CreateEventRequestDto request) {
